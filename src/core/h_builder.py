...
class HascalCompiler(object):
    def __init__(self, argv):
        ...
        if len(self.argv) > 1:
            if self.argv[1] == "-h" or self.argv[1] == "--help":
                # show help
                output_message = [
                    f"Hascal Compiler {HASCAL_COMPILER_VERSION} {sys.platform}",
                    ...
                    "other commands:", "\t--help,-h : show help",
                ...
                if not self.argv[1].endswith(".has"):
                    ...
                    HascalException(
                        f"Error : The specified file is not a hascal(.has) file"
                    )
                else:
                    try:
            ...
            output_message = [
                ...
                "All rights reserved.",
                "\nEnter following command for compile a Hascal program :",
                "hascal <inputfile.has>", "other commands:",
    ...
    def compile(self):
        ...
        try:
            ...
            output_messages = [
                "Error : Your code have error(s)", "Check these items :",
                "\t1-incompatible types",
                "\t2-functions arguements and types and length of arguments",
                "\t3-modify consts", "\tand more..."
