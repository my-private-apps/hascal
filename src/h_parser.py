...
class Parser(Parser):
   ...
   int main(int argc, char *argv[]){ "
    ...
    @_('FUNCTION NAME LPAREN RPAREN SEM in_statements END SEM')
    ...
    @_('FUNCTION NAME LPAREN RPAREN AS return_type SEM in_statements END SEM')
    def statement(self, p):
